export let Cropperjs = function () {
    ...
    const preload = async () => {
        ...
        window.__cropperjs_loaderPromise = (async () => {
            await loadAsset({ type: "js", url: "_content/TTVLMudThemeLibrary/plugins/cropperjs/cropper.js", location: "body" });
            await loadAsset({ type: "css", url: "_content/TTVLMudThemeLibrary/plugins/cropperjs/cropper.css", location: "before" });
        })();
